...
<head>
<meta charset="utf-8">
<title>Shape Multi purpose Bootstrap Website Template</title>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a class="waves-effect waves-dark" href="./">Gallery</a></li>
                        ...
                        <li><a class="waves-effect waves-dark" href="./login.php">Log In</a></li>
        ...
        <div class="row">
            <div class="col-sm-4 info-blocks">
                ...
                <div class="info-blocks-in">
                    ...
                    <p>Special desgin euipment for each body part</p>
                </div>
            </div>
            <div class="col-sm-4 info-blocks">
			...
			<div class="col-sm-3">
				<div class="widget">
					...
					JC Main Road, Near Silnile tower<br>
					 Pin-454135 Vadodara India.</address>
					<p>
						<i class="icon-phone"></i> (123) 456-789 - 1255-12584 <br>
						<i class="icon-envelope-alt"></i> 190510101173@paruluniversiy.ac.in
					</p>
				</div>
			</div>
			<div class="col-sm-3">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="copyright">
						<p>
							<span>&copy; Fitness 2020 All right reserved. </span> <a href="#" target="_blank">NKR Company Inc.</a>
						</p>
					</div>
				</div>
				<div class="col-lg-6">
