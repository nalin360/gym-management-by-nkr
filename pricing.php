...
<head>
<meta charset="utf-8">
<title>Shape Multi purpose HTML5 Website Template</title>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="./pricing.php" class="waves-effect waves-dark">Pricing</a></li>
			...
			<div class="col-sm-3">
				<div class="widget">
					...
					JC Main Road, Near Silnile tower<br>
					 Pin-451285 Vadodara India.</address>
					<p>
						<i class="icon-phone"></i> (123) 456-789 - 1255-12584 <br>
						<i class="icon-envelope-alt"></i> 190510101173@paruluniversity.ac.in
					</p>
				</div>
			</div>
			<div class="col-sm-3">
